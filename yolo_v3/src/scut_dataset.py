...
class SCUTDataset(Dataset):
    def __init__(self, root_path="/home/olga/Yolo-pytorch/data/SCUT_HEAD", part="Part_A", mode="train", image_size=448, is_training = True):
        if (mode in ["train", "val", "trainval", "test"] and part == "Part_A") or (
                mode in ["train", "val", "trainval", "test"] and part == "Part_B"):
            self.data_path = os.path.join(root_path, "SCUT_HEAD_{}".format(part))
